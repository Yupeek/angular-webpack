describe('App', function () {
  ...
  it('should have a main title', function () {
    expect(element(by.css('main h1')).getText()).toEqual('Hello from Yupeek angular2!');
  });

  it('should have <footer>', function () {
    expect(element(by.css('my-app footer')).getText()).toEqual("Inspired by Webpack Angular 2 Starter");
  });
